...
{
    // Create a modelList view matrix with object at 0, 0, -8
...
function draw(gl, obj) {
    ...
    // connect up the shader parameters: vertex position, color and projection/modelList matrices
    // set up the buffers
